...
class Person(val name : String = "",
    ...
    // init block can be used to run some initialization logic during the instance creation
  ...
  /*  val person = Person("Daya", 26)
   ...
   /* val person1 = Person()
    ...
    println("person2  Name : ${person2.name}  and the person2 Age is : ${person2.age}" +
            "and the person2 email is :${person2.email} and the nameLength is :${person2.nameLength}")
